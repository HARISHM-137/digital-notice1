        ...
        <div className="space-y-6">
            ...
            <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center gap-3">
                ...
                <p className="text-sm text-blue-700">
                    <strong>6 subjects</strong> are auto-assigned by the administrator based on your year and department. You cannot add or remove subjects.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <Card className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white">
                    ...
                    <p className="text-2xl font-bold">{assignments.length} / 6</p>
                </Card>
