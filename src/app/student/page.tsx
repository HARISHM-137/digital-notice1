    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-xs text-slate-400 mt-1">📚 Subjects are auto-assigned based on your year &amp; department</p>
            </div>
