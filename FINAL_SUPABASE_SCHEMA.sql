-- ============================================================
-- CO-PO ATTAINMENT SYSTEM — FINAL PRODUCTION SCHEMA
-- This is the complete, error-free schema to upload in Supabase
...
-- 4. Subjects (FIXED: code column exists, added updated cols)
...
-- ============================================================
-- SECTION 5: ADD MISSING COLUMNS TO EXISTING TABLES (IDEMPOTENT)
-- ============================================================
...
BEGIN
    ...
    -- Documents
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'documents' AND policyname = 'Allow all for authenticated') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'internal_test_questions' AND policyname = 'Allow all for authenticated') THEN
    ...
    -- End Sem Questions
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'end_sem_questions' AND policyname = 'Allow all for authenticated') THEN
